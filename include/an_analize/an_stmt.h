...
void public_function_stmt(struct an_parser *, struct an_node *);
void static_function_stmt(struct an_parser *, struct an_node *);
void private_function_stmt(struct an_parser *, struct an_node *);
