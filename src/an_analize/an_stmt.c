...
void for_header1_stmt(struct an_parser *parser, struct an_node *expr) {
    //TODO
}

void for_header2_stmt(struct an_parser *parser, struct an_node *expr) {
    //TODO
}

void for_stmt(struct an_parser *parser, struct an_node *expr) {
    // TODO
}
